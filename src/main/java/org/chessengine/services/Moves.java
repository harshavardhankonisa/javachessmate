...
public class Moves {
    ...
    public static String possibleMovesW(long WP, long WN, long WB, long WR, long WQ, long WK, long BP, long BN, long BB,
            long BR, long BQ, long BK, long EP, boolean CWK, boolean CWQ) {
    ...
    public static String possibleMovesB(long WP, long WN, long WB, long WR, long WQ, long WK, long BP, long BN, long BB,
            long BR, long BQ, long BK, long EP, boolean CBK, boolean CBQ) {
    ...
    public static String possibleWP(long WP, long BP, long EP) {
        ...
        while (possibility != 0) {
            ...
            list += String.valueOf(index / 8 + 1) + (index % 8 - 1) + (index / 8) + (index % 8);
        ...
        while (possibility != 0) {
            int index = Long.numberOfTrailingZeros(possibility);
            list += String.valueOf(index / 8 + 1) + (index % 8) + (index / 8) + (index % 8);
            PAWN_MOVES &= ~possibility;
            possibility = PAWN_MOVES & -PAWN_MOVES;
        }
        ...
        while (possibility != 0) {
            int index = Long.numberOfTrailingZeros(possibility);
            list += String.valueOf(index / 8 + 2) + (index % 8) + (index / 8) + (index % 8);
            PAWN_MOVES &= ~possibility;
            possibility = PAWN_MOVES & -PAWN_MOVES;
        }
        ...
        while (possibility != 0) {
            int index = Long.numberOfTrailingZeros(possibility);
            list += String.valueOf(index % 8 - 1) + (index % 8) + "QP" + (index % 8 - 1) + (index % 8) + "RP"
                    + (index % 8 - 1)
        ...
        while (possibility != 0) {
            int index = Long.numberOfTrailingZeros(possibility);
            list += String.valueOf(index % 8) + (index % 8) + "QP" + (index % 8) + (index % 8) + "RP" + (index % 8)
                    + (index % 8)
        ...
        if (possibility != 0) {
            int index = Long.numberOfTrailingZeros(possibility);
            list += String.valueOf(index % 8 - 1) + (index % 8) + "WE";
        }
        // en passant left
    ...
    public static String possibleBP(long BP, long WP, long EP) {
        ...
        if (possibility != 0) {
            int index = Long.numberOfTrailingZeros(possibility);
            list += String.valueOf(index % 8 + 1) + (index % 8) + "BE";
        }
        // en passant left
    ...
    public static String possibleN(long N) {
        ...
        while (i != 0) {
            ...
            while (j != 0) {
                ...
                list += String.valueOf(iLocation / 8) + (iLocation % 8) + (index / 8) + (index % 8);
                possibility &= ~j;
    ...
    public static String possibleCW(long WP, long WN, long WB, long WR, long WQ, long WK, long BP, long BN, long BB,
            long BR, long BQ, long BK, boolean CWK, boolean CWQ) {
        String list = "";
    ...
    public static String possibleCB(long WP, long WN, long WB, long WR, long WQ, long WK, long BP, long BN, long BB,
            long BR, long BQ, long BK, boolean CBK, boolean CBQ) {
        String list = "";
    ...
    public static long unsafeForBlack(long WP, long WN, long WB, long WR, long WQ, long WK, long BP, long BN, long BB,
    ...
    public static long unsafeForWhite(long WP, long WN, long WB, long WR, long WQ, long WK, long BP, long BN, long BB,
            long BR, long BQ, long BK) {
        long unsafe;
        OCCUPIED = WP | WN | WB | WR | WQ | WK | BP | BN | BB | BR | BQ | BK;
        // pawn
