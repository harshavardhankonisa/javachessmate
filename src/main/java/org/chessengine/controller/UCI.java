...
import org.chessengine.services.BoardGeneration;
import org.chessengine.services.ChessSearch;
import org.chessengine.services.Moves;

import java.util.Scanner;

import static org.chessengine.services.FunctionalConversion.algebraToMove;
import static org.chessengine.services.FunctionalConversion.moveToAlgebra;
...
public class UCI {
    ...
    private static void handlePositionCommand(String command) {
        ...
        if(command.contains("startpos ")){
            ...
            BoardGeneration.implementFen(defFenString);
        }
